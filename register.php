                ...
                <form action="<?php echo (URLROOT) ?>/process/p_register.php" method='POST'>
                    ...
                    <div class="form-group">
                        ...
                        <input type='name' name="name" value="<?php echo ($data['name']); ?>"
                            class="form-control form-control-lg <?php echo (isset($err['name_err'])) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type='text' name="username" value="<?php echo ($data['username']); ?>"
                            class="form-control form-control-lg <?php echo (isset($err['username_err'])) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type='email' name="email" value="<?php echo ($data['email']); ?>"
                            class="form-control form-control-lg <?php echo (isset($err['email_err'])) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type='text' name="website" value="<?php echo ($data['website']); ?>"
                            class="form-control form-control-lg <?php echo (isset($err['website_err'])) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type='password' name="password" value="<?php echo ($data['password']); ?>"
                            class="form-control form-control-lg <?php echo (isset($err['password_err'])) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type='password' name="confirm_password"
                            ...
                            class="form-control form-control-lg <?php echo (isset($err['confirm_password_err'])) ? 'is-invalid' : ''; ?>">
